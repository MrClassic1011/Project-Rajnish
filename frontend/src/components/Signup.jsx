      ...
      <div className={signupStyles.cardContainer}>
        <div className={signupStyles.header}>
          ...
          <p className={signupStyles.headerSubtitle}>
            Join Project R to save much money!
          </p>
        </div>
            ...
            <div className="mb-6">
              ...
              <div className={signupStyles.inputContainer}>
                ...
                <input
                  ...
                  className={`${signupStyles.input} ${errors.name ? "border-red-300" : "border-grey-200"}`}
                  placeholder="Pravin Ubale"
                />
              </div>
              {errors.name && (
            ...
            <div className="mb-6">
              ...
              <div className={signupStyles.inputContainer}>
                ...
                <input
                  ...
                  className={`${signupStyles.input} ${errors.email ? "border-red-300" : "border-grey-200"}`}
            ...
            <div className="mb-6">
              ...
              <div className={signupStyles.inputContainer}>
                ...
                <input
                  ...
                  className={`${signupStyles.passwordInput} ${errors.password ? "border-red-300" : "border-grey-200"}`}
                  placeholder="******"
                />
