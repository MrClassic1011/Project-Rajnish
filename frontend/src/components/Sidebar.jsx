...
const Sidebar = ({ user, isCollapsed, setIsCollapsed }) => {
  ...
  const { name: username = "User", email = "user@projectR.com" } = user || {};
      ...
      >
        <div className={sidebarStyles.sidebarInner.base}>
            ...
            <div className="flex items-center">
              ...
              {!isCollapsed && (
                <motion.div
                  ...
                  exit={{ opacity: 0, x: -10 }}
                >
                  <h2 className="text-sm font-bold text-grey-800 truncate">
                    {username}
                  </h2>
          ...
          <div className="flex-1 overflow-y-auto py-4 custom-scrollbar">
            <ul className={sidebarStyles.menuList.base}></ul>
            {MENU_ITEMS.map(renderMenuItem)}
          </div>
          {/* write a contact page logic, right now linking Youtube link*/}
          <div
            className={cn(
          ...
          >
            <Link
              className={cn(
                ...
                isCollapsed && sidebarStyles.footerLink.expanded,
              )}
            ...
            >
              <div className="relative h-full flex flex-col">
                <div className={sidebarStyles.mobileHeader}>
                  ...
                  >
                    <X size={24} className="text-grey-600" />
                  </button>
                </div>
